...
def get_epsilon_similar_input_values(input_values,delta=DELTA):
...
def find_properties_to_verify():
    wanted_number_of_properties = 50
    current_number_of_properties = 0
    number_of_networks = 40
    ...
    for i,good_property in enumerate(good_properties):
        ...
        for j in range(len(good_property)):
            print(f'\t\t\t({j},', end=" ")
            print(r"{", end="")
            print(f'"Lower": {good_property[j] - DELTA}, "Upper": {good_property[j] + DELTA}', end="")
            print(r"}),")
        print(f'\t\t],')
        # output
        print(f'\t"output":')
        ...
        for j in range(len(outputs[i])):
            print(f'\t\t\t({j},', end=" ")
            print(r"{", end="")
            print(f'"Lower": {outputs[i][j] - DELTA}, "Upper": {outputs[i][j] + DELTA}', end="")
            print(r"}),")
        print(f'\t\t]')
        print(r"},")
